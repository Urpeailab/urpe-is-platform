  ...
  return (
    <div className="min-h-screen bg-[#0F172A] pb-24 sm:pb-8">
      <div className="px-4 sm:px-6 lg:px-8 py-6 max-w-5xl mx-auto space-y-6">
        {/* Encabezado */}
        <div className="mb-6">
          <h1 className="text-2xl sm:text-3xl font-semibold text-[#F8FAFC] flex items-center gap-3 mb-2">
            <Library className="h-7 w-7 text-[#C9A96A]" />
            Biblioteca Legal
          </h1>
        ...
        <div className="relative">
          ...
          <Input
            ...
            className="pl-11 bg-[#1E293B] border-[#334155] text-[#F8FAFC] h-12 rounded-xl focus:border-[#C9A96A]"
          />
        </div>

        {/* Pestañas */}
        <Tabs defaultValue="laws" className="w-full">
          <TabsList className="grid w-full grid-cols-4 bg-[#1E293B] border border-[#334155] rounded-xl h-12">
            <TabsTrigger value="laws" className="data-[state=active]:bg-[#C9A96A] data-[state=active]:text-[#0F172A] text-[#94A3B8] rounded-lg">
              <Scale className="h-4 w-4 mr-2 hidden sm:inline" />
              Leyes
            </TabsTrigger>
            <TabsTrigger value="manuals" className="data-[state=active]:bg-[#C9A96A] data-[state=active]:text-[#0F172A] text-[#94A3B8] rounded-lg">
              <BookOpen className="h-4 w-4 mr-2 hidden sm:inline" />
              Manuales
            </TabsTrigger>
            <TabsTrigger value="glossary" className="data-[state=active]:bg-[#C9A96A] data-[state=active]:text-[#0F172A] text-[#94A3B8] rounded-lg">
              <BookMarked className="h-4 w-4 mr-2 hidden sm:inline" />
              Glosario
            </TabsTrigger>
            <TabsTrigger value="caselaw" className="data-[state=active]:bg-[#C9A96A] data-[state=active]:text-[#0F172A] text-[#94A3B8] rounded-lg">
              <Gavel className="h-4 w-4 mr-2 hidden sm:inline" />
              Casos
            </TabsTrigger>
          </TabsList>

          {/* Pestaña de Leyes - Diseño compacto UX Laws */}
          <TabsContent value="laws" className="space-y-3 mt-6">
            {filteredLaws.map((law) => (
              <Card key={law.id} className="bg-[#1E293B] border border-[#334155] rounded-xl overflow-hidden">
                <CardContent className="p-4">
                  {/* Header compacto */}
                  <div className="flex items-start gap-3 mb-3">
                    <div className="h-10 w-10 rounded-lg bg-[#C9A96A]/20 flex items-center justify-center flex-shrink-0">
                      <Scale className="h-5 w-5 text-[#C9A96A]" />
                    </div>
                    <div className="flex-1 min-w-0">
                      <h3 className="text-[#F8FAFC] font-medium text-sm sm:text-base leading-tight">{law.title}</h3>
                      <p className="text-[#64748B] text-xs mt-1">{law.reference}</p>
                    </div>
                    {law.popular && (
                      <Badge className="bg-[#C9A96A]/20 text-[#C9A96A] border-0 text-xs flex-shrink-0">
                        Popular
                      </Badge>
                    )}
                  </div>
                  ...
                  {/* Descripción corta */}
                  <p className="text-[#94A3B8] text-sm mb-4 line-clamp-2">{law.description}</p>
                  
                  {/* Botones grandes - Fitts Law (min 48px) */}
                  <div className="grid grid-cols-2 gap-2">
                    <Button
                      onClick={() => toggleExpand(law.id)}
                      variant="outline"
                      className="min-h-[48px] border-[#334155] text-[#F8FAFC] hover:bg-[#334155] justify-center"
                    >
                    ...
                    <Button
                      ...
                      className="min-h-[48px] bg-[#C9A96A] hover:bg-[#B8956A] text-[#0F172A] justify-center"
                    >
                  ...
                  {/* Texto expandible */}
                  {expandedItems[law.id] && (
                    <div className="bg-[#0F172A] rounded-lg p-4 mt-4 border border-[#334155] max-h-[400px] overflow-y-auto">
                      <pre className="whitespace-pre-wrap text-[#E2E8F0] text-sm font-sans leading-relaxed">
                        {law.fullText}
                      </pre>
                    </div>
                  )}
          ...
          {/* Pestaña de Manuales - Diseño compacto UX Laws */}
          <TabsContent value="manuals" className="space-y-3 mt-6">
            {filteredManuals.map((manual) => (
              <Card key={manual.id} className="bg-[#1E293B] border border-[#334155] rounded-xl overflow-hidden">
                <CardContent className="p-4">
                  {/* Header compacto */}
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-[#F8FAFC] font-medium text-sm sm:text-base leading-tight">{manual.title}</h3>
                      <p className="text-[#64748B] text-xs mt-1">{manual.chapters} capítulos · {manual.lastUpdated}</p>
                    </div>
                  </div>
                  
                  {/* Descripción corta */}
                  <p className="text-[#94A3B8] text-sm mb-4 line-clamp-2">{manual.description}</p>
                  
                  {/* Botones grandes - Fitts Law */}
                  <div className="grid grid-cols-2 gap-2">
                    <Button
                  ...
                  {expandedItems[manual.id] && (
                    <div className="bg-[#0F172A] rounded-lg p-4 mt-4 border border-[#334155] max-h-[300px] overflow-y-auto">
                      <pre className="whitespace-pre-wrap text-[#E2E8F0] text-sm font-sans leading-relaxed">
                        {manual.content}
                      </pre>
                    </div>
          ...
          {/* Pestaña de Glosario - Diseño compacto UX Laws */}
          <TabsContent value="glossary" className="space-y-3 mt-6">
            {filteredGlossary.map((item) => (
              <Card key={item.id} className="bg-[#1E293B] border border-[#334155] rounded-xl overflow-hidden">
                <CardContent className="p-4">
                  {/* Header con término */}
                  <div className="flex items-center gap-3 mb-3">
                    <div className="h-10 w-10 rounded-lg bg-[#22C55E]/20 flex items-center justify-center flex-shrink-0">
                      <BookMarked className="h-5 w-5 text-[#22C55E]" />
                    </div>
                    <div>
                      <h3 className="text-[#F8FAFC] font-medium">{item.term}</h3>
                      <p className="text-[#64748B] text-xs">{item.relatedLaw}</p>
                    </div>
                  </div>
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="w-full min-h-[48px] border-[#334155] text-[#F8FAFC] hover:bg-[#334155] justify-center mb-3"
                  >
                  ...
                  {expandedItems[item.id] && (
                    <div className="bg-[#0F172A] rounded-lg p-4 border border-[#334155] max-h-[300px] overflow-y-auto">
                      <pre className="whitespace-pre-wrap text-[#E2E8F0] text-sm font-sans leading-relaxed">
                        {item.definition}
                      </pre>
                    </div>
          ...
          {/* Pestaña de Jurisprudencia - Diseño compacto UX Laws */}
          <TabsContent value="caselaw" className="space-y-3 mt-6">
            {filteredCaseLaw.map((caseItem) => (
              <Card key={caseItem.id} className="bg-[#1E293B] border border-[#334155] rounded-xl overflow-hidden">
                <CardContent className="p-4">
                  {/* Header compacto */}
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 flex-wrap">
                        <h3 className="text-[#F8FAFC] font-medium">{caseItem.title}</h3>
                        {caseItem.landmark && (
                      ...
                      <p className="text-[#64748B] text-xs mt-1">{caseItem.citation} · {caseItem.court} · {caseItem.year}</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-3">
                    <Button
                      ...
                      variant="outline"
                      className="min-h-[48px] border-[#334155] text-[#F8FAFC] hover:bg-[#334155] justify-center text-sm"
                    >
                      {expandedItems[`${caseItem.id}-summary`] ? 'Ocultar' : 'Resumen'}
                    </Button>
                    <Button
                      onClick={() => toggleExpand(`${caseItem.id}-impact`)}
                      className="min-h-[48px] bg-[#C9A96A] hover:bg-[#B8956A] text-[#0F172A] justify-center text-sm"
                    >
                  ...
                  {expandedItems[`${caseItem.id}-summary`] && (
                    <div className="bg-[#0F172A] rounded-lg p-4 border border-[#334155] mb-3 max-h-[250px] overflow-y-auto">
                      <h4 className="text-[#C9A96A] font-medium text-sm mb-2">Resumen del Caso</h4>
                      <pre className="whitespace-pre-wrap text-[#E2E8F0] text-sm font-sans leading-relaxed">
                        {caseItem.summary}
                      </pre>
                    </div>
                  ...
                  {expandedItems[`${caseItem.id}-impact`] && (
                    <div className="bg-[#0F172A] rounded-lg p-4 border border-[#22C55E]/30 max-h-[250px] overflow-y-auto">
                      <h4 className="text-[#22C55E] font-medium text-sm mb-2">Impacto Legal</h4>
                      <pre className="whitespace-pre-wrap text-[#E2E8F0] text-sm font-sans leading-relaxed">
                        {caseItem.impact}
                      </pre>
                    </div>
        ...
        {/* Banner Informativo */}
        <Card className="bg-[#1E293B] border border-blue-500/30 rounded-xl">
          <CardContent className="p-4">
            <div className="flex items-start gap-3">
              <BookOpen className="h-6 w-6 text-blue-400 flex-shrink-0 mt-0.5" />
              <div>
                <h3 className="font-semibold text-[#F8FAFC] mb-1">Recurso Educativo</h3>
