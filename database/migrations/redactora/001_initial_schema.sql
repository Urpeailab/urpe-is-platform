-- ============================================================================
-- Redactora — initial PostgreSQL schema (migration from MongoDB)
-- Session 1 of the Mongo→Supabase migration.
--
-- Strategy: keep document-style payloads as JSONB to minimize the diff
-- against existing MongoDB code. Common columns surfaced for indexability;
-- everything else lives in the `data` JSONB column.
--
-- Naming: snake_case. UUIDs as TEXT (existing code generates str(uuid.uuid4()).
...
-- ============================================================================
-- DOCUMENT-LIKE COLLECTIONS (uniform pattern)
-- All have: id, user_id, client_id, language, status, data (JSONB), timestamps
-- ============================================================================

-- Macro reduces boilerplate. Each table only adds the indexable surface fields.
...
-- LETTERS (multiple types share schema)
...
CREATE INDEX IF NOT EXISTS idx_chat_msg_conv ON redactora_chat_messages(conversation_id);
CREATE INDEX IF NOT EXISTS idx_chat_msg_ts ON redactora_chat_messages(timestamp);
...
-- ============================================================================
-- DESIGNED DOCUMENTS / EVALUATIONS
-- ============================================================================
